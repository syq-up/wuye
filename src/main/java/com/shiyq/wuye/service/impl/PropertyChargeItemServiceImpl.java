...
import com.shiyq.wuye.mapper.PropertyChargeItemMapper;
import com.shiyq.wuye.utils.DateUtils;
 ...
 */
@Service
public class PropertyChargeItemServiceImpl implements com.shiyq.wuye.service.PropertyChargeItemService {

    private final PropertyChargeItemMapper propertyChargeItemMapper;
    private final PropertyChargeVisitMapper propertyChargeVisitMapper;

    // 注入
    public PropertyChargeItemServiceImpl(PropertyChargeItemMapper propertyChargeItemMapper,
                                         PropertyChargeVisitMapper propertyChargeVisitMapper) {
        this.propertyChargeItemMapper = propertyChargeItemMapper;
        this.propertyChargeVisitMapper = propertyChargeVisitMapper;
    }
