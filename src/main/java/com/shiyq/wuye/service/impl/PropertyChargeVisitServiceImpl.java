 ...
 */
@Service
public class PropertyChargeVisitServiceImpl implements com.shiyq.wuye.service.PropertyChargeVisitService {

    private final PropertyChargeVisitMapper propertyChargeVisitMapper;

    // 注入
    public PropertyChargeVisitServiceImpl(PropertyChargeVisitMapper propertyChargeVisitMapper) {
