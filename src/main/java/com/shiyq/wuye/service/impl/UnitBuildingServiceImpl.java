...
import com.shiyq.wuye.mapper.HouseInfoMapper;
import com.shiyq.wuye.entity.DO.HouseInfo;
import org.springframework.stereotype.Service;
import com.shiyq.wuye.mapper.UnitBuildingMapper;
 ...
 */
@Service
public class UnitBuildingServiceImpl implements com.shiyq.wuye.service.UnitBuildingService {

    private final UnitBuildingMapper unitBuildingMapper;
    private final HouseInfoMapper houseInfoMapper;

    // 注入
    public UnitBuildingServiceImpl(UnitBuildingMapper unitBuildingMapper,
                                   HouseInfoMapper houseInfoMapper) {
        this.unitBuildingMapper = unitBuildingMapper;
