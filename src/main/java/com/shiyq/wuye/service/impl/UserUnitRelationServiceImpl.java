...
import com.shiyq.wuye.mapper.UserUnitRelationMapper;
 ...
 */
@Service
public class UserUnitRelationServiceImpl implements com.shiyq.wuye.service.UserUnitRelationService {

    private final UserUnitRelationMapper userUnitRelationMapper;

    // 注入
    public UserUnitRelationServiceImpl(UserUnitRelationMapper userUnitRelationMapper) {
        this.userUnitRelationMapper = userUnitRelationMapper;
    }
